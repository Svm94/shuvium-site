  ...
  return (
    <section id="pricing" className="relative w-full py-32 px-6 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10 glass-card rounded-[3rem] p-10 md:p-16 border border-shuvium-gold/20 shadow-[0_0_50px_rgba(0,0,0,0.8)]">
        ...
        >
          <h2 className="font-cinzel text-3xl md:text-5xl tracking-[0.1em] bg-gradient-to-r from-shuvium-gold to-white bg-clip-text text-transparent uppercase mb-10">
            The Prana Economy
          </h2>

          <div className="inline-flex glass-card p-1 rounded-full border border-shuvium-gold/40 relative">
            <button
              onClick={() => setCurrency("INR")}
              className={`relative z-10 px-8 py-3 rounded-full text-sm font-bold transition-all duration-300 ${
                currency === "INR" ? "text-shuvium-blue" : "text-shuvium-gold hover:text-white"
              }`}
            >
              INR
            </button>
            <button
              ...
              className={`relative z-10 px-8 py-3 rounded-full text-sm font-bold transition-all duration-300 ${
                currency === "USD" ? "text-shuvium-blue" : "text-shuvium-gold hover:text-white"
              }`}
            >
              USD
            </button>
            ...
            <motion.div
              layout
              className="absolute top-1 bottom-1 w-1/2 bg-gradient-to-r from-shuvium-gold to-yellow-300 rounded-full z-0"
              initial={false}
              animate={{
        ...
        >
          ...
          >
            ...
            <div className="text-5xl font-bold mb-8 text-shuvium-gold font-inter flex items-baseline">
            ...
            <ul className="space-y-6 mb-12 flex-1 text-sm text-gray-300 font-light">
              <li className="flex items-start gap-4">
                <span className="text-shuvium-gold font-bold">✓</span> 3 Daily Free Pranas
              </li>
              <li className="flex items-start gap-4">
                <span className="text-shuvium-gold font-bold">✓</span> Gated Daily Insights
              </li>
              <li className="flex items-start gap-4">
                <span className="text-shuvium-gold font-bold">✓</span> Basic Micro-Rituals
              </li>
            </ul>
            <button className="w-full py-4 rounded-xl border border-shuvium-gold/50 text-shuvium-gold font-cinzel tracking-wider hover:bg-shuvium-gold/10 transition-colors uppercase text-sm">
              Current Path
            </button>
          </motion.div>
          ...
          >
            ...
            <div className="text-5xl font-bold mb-8 text-white font-inter flex items-baseline">
              <span className="text-3xl mr-1 text-shuvium-gold/80">{prices[currency].symbol}</span>
              {prices[currency].pro}
              <span className="text-sm opacity-50 font-normal ml-2 tracking-wide">/mo</span>
            </div>
            <ul className="space-y-6 mb-12 flex-1 text-sm text-gray-100 font-light">
              <li className="flex items-start gap-4 text-shuvium-gold drop-shadow-md">
                <span className="font-bold">★</span> Unlimited Daily Insights
              </li>
              <li className="flex items-start gap-4">
                <span className="text-shuvium-gold font-bold">✓</span> Advanced Personalized Routines
              </li>
              <li className="flex items-start gap-4">
                <span className="text-shuvium-gold font-bold">✓</span> Sutra Card Roster Access
              </li>
              <li className="flex items-start gap-4">
                <span className="text-shuvium-gold font-bold">✓</span> Weekly Darshan Puzzle Fragments
              </li>
            </ul>
            <button className="w-full py-4 rounded-xl bg-gradient-to-r from-shuvium-gold to-yellow-300 text-shuvium-blue font-bold font-cinzel tracking-wider hover:shadow-[0_0_20px_rgba(212,175,55,0.4)] transition-all duration-300 uppercase text-sm hover:-translate-y-1">
              Power Up Now
            </button>
          </motion.div>
        </motion.div>
