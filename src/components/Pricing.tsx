        ...
        >
          ...
          >
            <button
              ...
              className={`relative z-10 px-8 py-3 rounded-full text-sm font-bold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-shuvium-orange focus-visible:ring-offset-2 focus-visible:ring-offset-shuvium-blue ${
